...
$stid5 = oci_parse($conn,"Select * from product where PRODUCT_CATEGORY='dairy'");
oci_execute($stid5);
echo '<div class="container content-section">';   
echo '<h2 class="section-header">Dairy Products</h2>';
echo '<h3 class="h3">';
echo 'Highest Quality of Dairy Products';
echo '</h3>';
echo '<div class="shop-items">';
while(($row = oci_fetch_array($stid5, OCI_BOTH)) != false) {
