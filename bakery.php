...
<!-- for the Bakery Products category -->
<?php 
$conn = oci_connect('TestSchema', '12345', '//localhost/xe') or die(oci_error()); 
$stid6 = oci_parse($conn,"Select * from product where PRODUCT_CATEGORY='cake'");
oci_execute($stid6);
echo '<div class="container content-section">';   
echo '<h2 class="section-header">Bakery</h2>';
echo '<h3 class="h3">';
echo 'Freshly Baked Buns and cakes';
echo '</h3>';
