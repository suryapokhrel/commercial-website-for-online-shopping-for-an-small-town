...
$stid = oci_parse($conn,"Select * from product where PRODUCT_CATEGORY='vegetables'");
oci_execute($stid);
echo '<div class="container content-section">';   
echo '<h2 class="section-header">Vegetables</h2>';
echo '<h3 class="h3">';
echo 'Highest Quality Vegetables in the area';
echo '</h3>';
