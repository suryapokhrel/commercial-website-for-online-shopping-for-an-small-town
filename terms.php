...
<body>
    <div class="container">
        ...
        <h3 style="align-content: flex-end;">Terms and Conditions</h3>
        <hr>
        <h1>OVERVIEW</h1>
        This website or Application is operated by Team WeKeepers. Throughout the site, the terms "we", "us" and "our"
        refer to CHFFreshSales. CHFFreshSales offers this website/application, including all information, tools and
        services available from this site/application to you, the user, conditioned upon your acceptance of all terms,
        conditions, policies and notices stated here.
        Please feel free to reach out to us at our Customer Care Helpline: +44 7911 123456<br><br>
        Should you have any clarifications regarding the Terms of Service, please do not hesitate to contact us at
        CHFFreshSales2022.com
        ...
        By agreeing to these Terms of Service, you represent that you are at least the age of majority in your Country
        or Province of residence, or that you are the age of majority in your Country or province of residence and you
        have given us your consent to allow any of your minor dependents to use this site.<br>
        You may not use our products for any illegal or unauthorized purpose nor may you, in the use of the Service,
        violate any laws in your jurisdiction (including but not limited to copyright laws).<br>
        ...
        involve <br>(a) transmissions over various networks; and <br>(b) changes to conform and adapt to technical requirements
        of connecting networks or devices. <br>Credit card information is always encrypted during transfer over networks.
        ...
        information. Any reliance on the material on this site is at your own risk.<br>
        ...
        may contain more and/or different information. It is recommended not to solely rely on the information
        presented.
        ...
        We are and shall be under no obligation<br> (1) to maintain any comments in confidence;<br> (2) to pay
        compensation for any commentsor or;<br> (3) to respond to any comments.<br>
        ...
        <h2>SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h2>
                ...
                the site or its content: <br> (a) for any unlawful purpose; <br> (b) to solicit others to perform or
                participate in any unlawful acts; <br> (c) to violate any international, federal, provincial or state
                regulations, rules, laws, or local ordinances; <br> (d) to infringe upon or violate our intellectual
                property rights or the intellectual property rights of others; <br> (e) to harass, abuse, insult, harm,
                defame, slander, disparage, intimidate, or discriminate based on gender, sexual orientation, religion,
                ethnicity, race, age, national origin, or disability; <br> (f) to submit false or misleading
                ...
                website, other websites, or the Internet; <br> (h) to collect or track the personal information of
                others; <br> (i) to spam, phish, pharm, pretext, spider, crawl, or scrape; <br> (j) for any obscene or
                immoral purpose; or<br> (k) to interfere with or circumvent the security features of the Service or any
                ...
                non-infringement. In no case shall CHFFreshSales, our directors, officers, employees, affiliates,
                ...
                You agree to indemnify, defend and hold harmless CHFFreshSales and our parent, subsidiaries, affiliates,
                ...
                and construed in accordance with the laws of UK laws.
                ...
                Questions about the Terms of Service should be sent to us at CHFFreshSales2022.com
